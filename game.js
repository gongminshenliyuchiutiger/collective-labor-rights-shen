...
const scenarios = {
    ...
    c0_scam_fail: {
        ...
        text: "【大危機】你單打獨鬥去跟老闆爭取，立刻就被找藉口開除了！記住，團結力量大，你需要找到志同道合的夥伴！",
    ...
    c1_union_init: {
        ...
        options: [
            { text: "只好放棄了，人數不夠也是沒辦法的事。", next: "c1_union_fail", type: "bad" },
    ...
    c1_union_fail: {
        ...
        text: "【失敗】你輕易就放棄了！勞工作為弱勢群體，除了企業工會之外，還可以跨越公司藩籬，尋求產業工會或職業工會的支持！",
    ...
    c2_ulp_init: {
        ...
        options: [
            { text: "老闆好可怕，我不敢搞工會了...", next: "c2_ulp_fail", type: "bad" },
    ...
    c2_ulp_fail: {
        ...
        text: "【損失權益】你被老闆唬住了！工會法第35條保障了打頭陣的幹部，這種帶有報復性質的解僱在勞動部裁決中絕對是無效的！",
    ...
    c3_bargain_init: {
        ...
        options: [
            { text: "老闆真佛心，大家都有福利最好了！", next: "c3_bargain_fail", type: "bad" },
    ...
    c3_bargain_fail: {
        speaker: "資深會員", role: "工會視角", avatar: "fa-users-slash",
        text: "【嚴重吃虧】你上當了！如果沒繳會費、沒抗爭的人也能免費享受成果，大家都會退出工會，工會最後就會瓦解！",
    ...
    c4_faith_init: {
        ...
        options: [
            { text: "公司既然有困難，那就明年再看看吧...", next: "c4_faith_fail", type: "bad" },
    ...
    c4_faith_fail: {
        ...
        text: "【錯失良機】資方這是在使用拖延戰術！法令規定雇主有誠信協商的義務，不能永遠拿「沒空」或「機密」來當擋箭牌！",
    ...
    c5_dispute_init: {
        ...
        options: [
            { text: "說得對！欠債還錢，罷工討回公道！", next: "c5_dispute_fail", type: "bad" },
    ...
    c5_dispute_fail: {
        ...
        text: "【違法罷工】為「權利事項」(已經既有的權利被侵害)罷工是違法的！這類爭議請直接去勞工局申訴或法院告他。只有爭取加薪等「調整事項」才能準備罷工！",
    ...
    c6_mediate_init: {
        ...
        options: [
            { text: "立刻發布新聞稿，明天包圍老闆辦公室！", next: "c6_mediate_fail", type: "bad" },
    ...
    c6_mediate_fail: {
        ...
        text: "【程序錯誤】太衝動了！沒有經過調解程序直接罷工，會被認定為非法罷工，參與者將不受免責保護，甚至可能被解僱！",
    ...
    c7_vote_init: {
        ...
        options: [
            { text: "理事長英明！我們聽你的！", next: "c7_vote_fail", type: "bad" },
    ...
    c7_vote_fail: {
        ...
        text: "【越權行為】理事長或幹部無權單方面宣布罷工！缺乏會員大會「無記名投票」背書的罷工，在法律上站不住腳，也會失去正當性！",
    ...
    c8_strike_init: {
        ...
        options: [
            { text: "老闆看起來要來真的，我們先撤退好了...", next: "c8_strike_fail", type: "bad" },
    ...
    c8_strike_fail: {
        ...
        text: "【被道德綁架】罷工的核心就是造成雇主經濟壓迫以換取談判籌碼！只要不使用暴力，設置糾察線是合法的爭議行為，不要退縮！",
    ...
    c9_success_init: {
        ...
        text: "（罷工第三天）產線停擺損失太慘重了... 好啦好啦，我服了！我答應你們全面調薪 10%，請大家明天趕快回來上班恢復生產！",
        hint: "口說無憑，千萬不要被老闆的花言巧語騙了！",
        options: [
            { text: "太棒了！大家明天復工！", next: "c9_success_fail", type: "bad" },
    ...
    c9_success_fail: {
        ...
        text: "【功虧一簣】太天真了！老闆如果事後翻臉不認帳，你這次的罷工就白費了！一定要將承諾落實為具有法律效力的「團體協約」！",
